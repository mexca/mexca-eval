...
To better investigate whether the **duration** of the **speaking** **time** of each **speaker** would affect performance, speakers' speaking duration is manipulated to follow an exponential distribution.
