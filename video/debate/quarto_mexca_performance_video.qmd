...
ggplot2::ggplot(mexca_video_performance, ggplot2::aes(tot_frames, f1_score)) +
  ggplot2::geom_point(shape = 21, size = 4)+
  ggplot2::scale_y_continuous(breaks=seq(0, 1, 0.2), limits=c(0, 1))+
  ggplot2::scale_x_continuous(breaks=seq(100, 1402, 100), limits=c(100, 1402))+
  ggplot2::ylab("f1 score") +
  ggplot2::xlab("n of frames") +
  ggplot2::theme_classic() +
  ggplot2::geom_smooth(se = FALSE, colour = "black", linetype = 2)
```
