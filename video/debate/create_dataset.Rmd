...
```{r Q1, eval=FALSE}
make_clip(number_of_speakers = seq_len(3), annotations = camera_shots_annotation, contemporaries = T, n_unique_combinations = 1)
```
...
```{r Q2, eval=FALSE}
make_clip(number_of_speakers = 1, camera_shots_annotation, contemporaries = F, n_unique_combination = 2:10) #note that starting from 1 makes a dataset equivalent to Q1
